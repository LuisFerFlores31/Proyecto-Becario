...
function MM_sldrUpdate(dragging) {
  ...
  if (!this.disabled) with (this) {
	...
	} else { //Used for fixing problem with the text field displaying properly on a Mac.
		if (navigator.platform != "Win32") {
			...
			switch(pos){
				case -1:
					break;
				case 0:
					value = "0." + str.substr(1,3);
					break;
				case 1:
					value = str.substr(0,1) + "." + str.substr(2,3);
					break;
				case 2:
					value = str.substr(0,2) + "." + str.substr(3,2);
					break;
				case 3:
					value = str.substr(0,3) + "." + str.substr(4,1);
					break;
				case 4:
					value = parseInt(str);
					break;
